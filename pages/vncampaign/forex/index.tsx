...
const Campaign: React.FC = (props: any) => {
  ...
  const bannerPoints = [
    { text: "Leverage up to 1:1000", isBold: false },
    { text: "Diverse currency pairs for your selection", isBold: false },
    { text: "Best trading experience with MT4 & MT5", isBold: false },
    { text: "Spreads starting from 1.6 Pips", isBold: true },
  ];
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/static/images/landing-page/vncampaign/forex-page-bg.png')`,
          height: "100%",
        ...
        <div className="stkbnx-container mx-auto md:py-10 xl:py-10 lg:py-10 py-4">
          ...
          <div className="flex sm:flex-col md:flex-col lg:flex-row flex-col justify-between items-center lg:space-x-10 xl:space-x-10 trade-register">
            ...
            >
              ...
              >
                {t(
                  "Optimize your forex trading with fees starting from just 1.6 PIPS"
                )}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 100 }}
              ...
              >
                {t(
                  "Enhance your performance with Stockbanx - a reliable broker with 14 years in the market."
                )}
              </motion.p>
