...
const Campaign: React.FC = (props: any) => {
  ...
  const bannerPoints = [
    { text: "Easy entry with small capital", isBold: false },
    { text: "Buying/selling US and European stocks", isBold: false },
    { text: "Best trading experience with MT4 & MT5", isBold: false },
    { text: "Especially 0% commission fee*", isBold: true },
    { text: "30+ FX INDUSTRY AWARDS", isBold: false },
  ];
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/static/images/landing-page/vncampaign/stock-page-bg.png')`,
          height: "100%",
        ...
        <div className="stkbnx-container mx-auto md:py-10 xl:py-10 lg:py-10 py-4">
          ...
          <div className="flex sm:flex-col md:flex-col lg:flex-row flex-col justify-between items-center lg:space-x-10 xl:space-x-10 trade-register">
            ...
            >
              ...
              >
                {t("Accelerate your international STOCK INVESTMENTS")}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 100 }}
                animate={{ opacity: 1, y: 1 }}
              ...
              >
                {t(
                  "Guidance on investing in US and European stocks with Stockbanx - a reliable broker with 14 years in the market."
                )}
              </motion.p>
