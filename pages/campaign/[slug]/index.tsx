...
// import FacebookPixel from "@/components/campaign/FacebookPixel";
...
const Campaign: React.FC = (props: any) => {
  ...
  return (
    <>
            ...
            <div className="disc">
              ...
              {props?.slug === "axis" && (
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: t(
                      "CFDs are complex instruments and come with a high risk of losing money rapidly due to leverage. More than 75% of retail investor accounts lose money when trading CFDs. You should consider whether you understand how CFDs work and whether you can afford to take the high risk of losing your money.",
                      {
                        interpolation: { escapeValue: false },
                      }
                    ),
      ...
      {props.slug === "radiant" && openBonusModal && (
        <BonusModal onClose={() => setOpenBonusModal(false)} />
      )}
    </>
  );
};
