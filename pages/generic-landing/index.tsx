...
import LandingPageRegister from "@/components/form/LandingPageRegister";
...
function GenericLanding() {
  ...
  return (
    <>
      <Head>
        {/* <script defer id="convrs-webchat" src="https://webchat.conv.rs/12b8de18010ade19338d5e97776b890b6c92742c.js"></script> */}
        <script
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/static/images/landing-page/main-bg.jpg')`,
          height: "100%",
        ...
        <div className="stkbnx-container mx-auto md:py-10 xl:py-10 lg:py-10 py-4">
          ...
          <div className="flex sm:flex-col md:flex-col lg:flex-row flex-col justify-between items-center lg:space-x-10 xl:space-x-10 trade-register">
            ...
            >
              ...
              >
                {t("Elevate Your Trading Game with Stockbanx!")}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 100 }}
                animate={{ opacity: 1, y: 1 }}
              ...
              >
                {t(
                  "Trade the Global Markets with a regulated broker! Forex, Indices, Stocks, Crypto – Trade anytime, anywhere!"
                )}
              </motion.p>
      ...
      <div className="stkbnx-container md:py-10 xl:py-32 lg:py-32 py-4 md:mt-0 xl:mt-0 lg:mt-0">
        ...
        >
          <div className="stkbnx-heading !text-center mb-2 text-white">
            ...
            trading.map((item: any, i: any) => {
              return (
                ...
                >
                  ...
                  >
                    <div className="partner-box text-white">
                      <Image
                        src={item.image}
                        alt="rebate"
                        width={80}
                      ...
                      <p className="text-sm para-text">{t(item.description)}</p>
                    </div>
                  </motion.div>
                </div>
              );
        ...
        <div className="flex sm:flex-col lg:flex-row lg:space-x-8 xl:space-x-8 sm:space-x-0 flex-col justify-between items-center mt-10 trade-heading">
          {global.length > 0 &&
            global.map((item: any, i: any) => {
              return (
                <div
                  className={`md:basis-1/3 md:w-3/6 w-full gb-box mb-8 ${styles.globalBboxLandingPage}`}
                  key={i}
                >
                  <motion.div
                    initial="hidden"
        ...
        <div className="flex sm:flex-col lg:flex-row flex-col justify-between items-center">
          <div className="md:basis-2/5 lg:mt-0 xl:mt-0">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <div className="stkbnx-heading mb-5 leading-7 text-white">
                {" "}
      ...
      <div className="stkbnx-container py-4">
        <motion.div
          initial="hidden"
          whileInView="visible"
          className="stkbnx-heading !text-center mb-2 text-white"
          viewport={{ once: true }}
          variants={{
            hidden: { opacity: 0, y: 50 },
            visible: { opacity: 1, y: 1 },
