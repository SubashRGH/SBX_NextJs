...
function LandingPageRegister({ submitText, title, slug }: Props) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit(formSubmit)}>
        ...
        <div className="generic-landing-page-form-container">
        ...
        <div className="formData">
          <input
            className="cmn-btn bg-primary  promote-btn rounded-full cursor-pointer border-0"
            type="submit"
            value={submitText}
          />
          <div
